...
<?php endif; ?>
        ...
        <p>Welcome back, <?php echo htmlspecialchars($_SESSION["username"]); ?>!</p>
            ...
            <p><?php echo "DEBUG: tenant_id " . htmlspecialchars($_SESSION["tenant_id"]); ?></p>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-3 text-center">
                ...
                ?>
                  ...
                  <img src="<?= $imagePath ?>" alt="Tenant Image" class="img-fluid rounded-circle mb-3" style="max-width: 150px;">
